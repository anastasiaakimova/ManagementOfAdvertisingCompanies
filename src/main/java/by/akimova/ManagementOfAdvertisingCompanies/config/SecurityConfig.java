...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/advertisers/**", "/campaigns/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/users/**").fullyAuthenticated()
                .antMatchers(HttpMethod.POST, "/campaigns/**", "/advertisers/").fullyAuthenticated()
                .antMatchers(HttpMethod.DELETE, "/campaigns/**", "/advertisers/").fullyAuthenticated()
